...
function ProductClients() {
  return (
    <ul className="grid grid-cols-1 mx-auto lg:grid-cols-3 gap-x-16 gap-y-12 lg:gap-y-32 max-w-35r lg:max-w-none">
      ...
      <li className="flex items-center justify-center order-2 col-span-2 px-12 py-24 bg-black rounded-xl">
        <Image
      ...
      <li className="flex items-center justify-center order-4 col-span-2 px-12 py-24 bg-black lg:order-3 rounded-xl">
        <Image
